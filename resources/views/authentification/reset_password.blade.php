				...
				<div class="d-flex flex-center w-lg-50 p-10">
					...
					<div class="card rounded-3 w-md-550px">
						...
						<div class="card-body p-10 p-lg-20">
							<!--begin::Form-->
							<form class="form w-100" novalidate="novalidate" id="kt_password_reset_form" data-kt-redirect-url="../../demo4/dist/authentication/layouts/creative/new-password.html" action="#">
								<!--begin::Heading-->
								...
								<div class="d-flex flex-wrap justify-content-center pb-lg-0">
									...
									<a href="../../demo4/dist/authentication/layouts/creative/sign-in.html" class="btn btn-light">Cancel</a>
								</div>
								<!--end::Actions-->
							</form>
							<!--end::Form-->
