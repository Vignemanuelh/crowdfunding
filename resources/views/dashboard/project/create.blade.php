...
<div class="container-xxl" id="kt_content_container">
    ...
    <div class="card">
        ...
        <div class="card-header">
            <!--begin::Card title-->
            <div class="card-title fs-3 fw-bold">Create Project</div>
            <!--end::Card title-->
        </div>
        @if ($errors->any())
        ...
        <!--end::Card header-->
        <!--begin::Form-->
        <form id="kt_project_settings_form" method="post" action="{{route('pstore')}}" enctype="multipart/form-data">
            @csrf
            <!--begin::Card body-->
            <div class="card-body p-9">
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true">
                            ...
                            <div class="image-input-wrapper w-125px h-125px bgi-position-center" style="background-size: 75%; background-image : url('{{ old('image') }}') "></div>
                ...
                <div class="row mb-8">
                    ...
                    <!--begin::Col-->
                    <div class="col-xl-9 fv-row">
                        <input type="text" class="form-control form-control-solid" name="financial_goal" value="{{ old('financial_goal') }}"/>
                    </div>
                </div>
                <!--end::Row-->
                <!--begin::Row-->
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-xl-9 fv-row">
                        <div class="position-relative d-flex align-items-center">
                            ...
                            <!--end::Svg Icon-->
                            <input type="date" class="form-control form-control-solid ps-12" name="start_date" value="{{ old('start_date') }}" placeholder="Pick a date" id="kt_datepicker_1" />
                        </div>
                    </div>
                    <!--begin::Col-->
                </div>
                 ...
                 <div class="row mb-8">
                    ...
                    <div class="col-xl-9 fv-row">
                        <div class="position-relative d-flex align-items-center">
                            ...
                            <!--end::Svg Icon-->
                            <input type="date" class="form-control form-control-solid ps-12" name="end_date" value="{{ old('end_date') }}" placeholder="Pick a date" id="kt_datepicker_1" />
                        </div>
                    </div>
                    <!--begin::Col-->
                </div>
