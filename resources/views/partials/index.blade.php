                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="d-flex flex-column h-100">
                                                    ...
                                                    <div class="d-flex align-items-center flex-wrap d-grid gap-2">
                                                        ...
                                                        <div class="d-flex align-items-center me-5 me-xl-13">
                                                            ...
                                                            <div class="m-0">
                                                                ...
                                                                <a href="../../demo4/dist/pages/user-profile/overview.html" class="fw-bold text-gray-800 text-hover-primary fs-7">Robert Fox</a>
                                                            </div>
                                                            <!--end::Info-->
                                                        </div>
                                                        <!--end::Item-->
                                                ...
                                                <div class="d-flex flex-stack mt-auto bd-highlight">
                                                    ...
                                                    <!--end::Users group-->
                                                    <!--begin::Actions-->
                                                    <a href="../../demo4/dist/apps/projects/project.html" class="text-primary opacity-75-hover fs-6 fw-semibold">View Project
                        ...
                        <div class="col-xl-8">
                            ...
                            <div class="card card-flush h-md-100">
                                ...
                                <div class="card-header pt-7">
                                    ...
                                    <!--begin::Toolbar-->
                                    <div class="card-toolbar">
                                        <a href="../../demo4/dist/apps/ecommerce/catalog/add-product.html" class="btn btn-sm btn-light">History</a>
                                    </div>
                                    <!--end::Toolbar-->
                                </div>
                                <!--end::Header-->
                            ...
                            <div class="card h-md-100">
                                ...
                                <div class="card-body d-flex flex-column flex-center">
                                    ...
                                    <div class="text-center mb-1">
                                        ...
                                        <!--end::Link-->
                                        <!--begin::Link-->
                                        <a class="btn btn-sm btn-light" href="../../demo4/dist/apps/user-management/users/view.html">Learn More</a>
                                        <!--end::Link-->
                                    </div>
                                    <!--end::Links-->
                                </div>
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            ...
                            <div class="overflow-auto pb-5">
                                ...
                                <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
                                    <!--begin::Title-->
                                    <a href="../../demo4/dist/apps/projects/project.html" class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Meeting with customer</a>
                                    <!--end::Title-->
                                    <!--begin::Label-->
                                ...
                                <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
                                    <!--begin::Title-->
                                    <a href="../../demo4/dist/apps/projects/project.html" class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Project Delivery Preparation</a>
                                    <!--end::Title-->
                                    <!--begin::Label-->
                                ...
                                <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                                    ...
                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                        ...
                                        <div class="ms-1 fw-semibold">
                                            <!--begin::Desc-->
                                            <a href="../../demo4/dist/apps/projects/project.html" class="fs-6 text-hover-primary fw-bold">Finance KPI App Guidelines</a>
                                            <!--end::Desc-->
                                            <!--begin::Number-->
            ...
            <div id="kt_help_scroll" class="hover-scroll-overlay-y" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_help_body" data-kt-scroll-dependencies="#kt_help_header" data-kt-scroll-offset="5px">
                ...
                <div class="d-flex align-items-center mb-7">
                    ...
                    <div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                        ...
                        <div class="d-flex flex-column me-2 me-lg-5">
                            <!--begin::Title-->
                            <a href="../../demo4/dist/documentation/getting-started.html" class="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">Documentation &amp; Videos</a>
                            <!--end::Title-->
                            <!--begin::Description-->
                ...
                <div class="d-flex align-items-center mb-7">
                    ...
                    <div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                        ...
                        <div class="d-flex flex-column me-2 me-lg-5">
                            <!--begin::Title-->
                            <a href="../../demo4/dist/documentation/base/utilities.html" class="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">Plugins &amp; Components</a>
                            <!--end::Title-->
                            <!--begin::Description-->
                ...
                <div class="d-flex align-items-center mb-7">
                    ...
                    <div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                        ...
                        <div class="d-flex flex-column me-2 me-lg-5">
                            <!--begin::Title-->
                            <a href="https://preview.keenthemes.com/metronic8/demo4/layout-builder.html" class="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">Layout Builder</a>
                            <!--end::Title-->
                            <!--begin::Description-->
                ...
                <div class="d-flex align-items-center mb-7">
                    ...
                    <div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                        ...
                        <div class="d-flex flex-column me-2 me-lg-5">
                            <!--begin::Title-->
                            <a href="../../demo4/dist/documentation/getting-started/changelog.html" class="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">What's New</a>
                            <!--end::Title-->
                            <!--begin::Description-->
